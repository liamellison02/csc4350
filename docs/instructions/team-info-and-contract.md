...
- ~~running meetings (when, where, face-to-face vs. online)~~
...
- ~~What will you do when a member is absent from a meeting?~~
  - ~~How will you plan to continue dividing the work?~~
  - ~~Will you send them the next actions needed to progress?~~

~~**You must also determine what should happen when you have members that have not contributed to the project.**~~

- ~~How  much of a percentage of the group assignment grade should that member get?~~
...
- ~~Contingency planning:~~
  ...
  - ~~what if a team member consistently misses meetings,~~
  - ~~what if a team member is academically dishonest, ...~~

Each team member needs to create GitHub account.
Include each member's GitHub account name in the write-up.
Create a repo for your team and include a link to the repo in the document as well.
Instructions on creating a git account and repo are in the iCollege course under resources.
